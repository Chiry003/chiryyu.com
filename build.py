...
META = {
    ...
    '11_泰国PDPA数据合规.md': {
        ...
        'date': '2026-06-17', 'desc': 'PDPC从制度建设期转入执法深化期，2025年罚款超1.2亿泰铢。本文详解五大高风险场景与PDPA/GDPR/PIPL三方合规要点。',
    },
    '12_柬埔寨劳动法实务.md': {
        'slug': '12-cambodia-labor-law', 'region': '柬埔寨', 'tag': '劳动法',
        'date': '2026-06-18', 'desc': '2022年《工会法》降至15人可建工会，2022年修法将欠薪追溯期翻倍至6个月。拆解雇佣、解雇、罢工与NSSF合规全流程。',
    },
    '13_马来西亚AMLA反洗钱合规.md': {
    ...
    '20_中国ODI备案全流程.md': {
        ...
        'date': '2026-06-26', 'desc': '发改委11号令+商务部3号令+外汇登记，三轨并行。备案vs核准vs报告，敏感行业穿透审查，事后报告义务——ODI全流程实操指引。',
    },
}
