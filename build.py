...
META = {
    ...
    '41_马来西亚税务制度与投资激励.md': {
        'slug': '41-malaysia-tax', 'region': '马来西亚', 'tag': '税务合规',
        'date': '2026-07-19', 'desc': '2025年RMCD转让定价稽查占追缴额36%。拆解24%企业所得税、SST 2.0、预提税体系、Pioneer Status/ITA/RA三重激励，以及三层转让定价文档的合规要求。',
        'faq': [
            ('马来西亚企业所得税税率是多少？','标准税率24%，中小企业首60万令吉适用15%优惠税率。马来西亚实行地域来源课税制——海外来源收入在满足实质条件下免税。2024年起对非上市公司股份处置征收10%资本利得税。'),
            ('外国企业在马来西亚可以享受哪些税收优惠？','核心激励工具：Pioneer Status（5-10年免70%所得税）、Investment Tax Allowance（合格资本支出60%-100%抵扣）、Reinvestment Allowance（制造业再投资60%抵扣15年）。数字/生物科技/航空航天等行业有额外专项激励。'),
        ],
        'related': ['13-malaysia-amla','19-malaysia-competition','33-malaysia-employment'],
    },
    '42_马来西亚外资准入与市场进入.md': {
        'slug': '42-malaysia-foreign-investment', 'region': '马来西亚', 'tag': '投资法',
        'date': '2026-07-20', 'desc': '马来西亚外资准入"隐性监管"——30余部行业法分散规定外资持股上限。拆解制造业/服务业分行业限制、公司设立流程、四种市场进入策略及NIA 2024-2030国家投资愿景的影响。',
        'faq': [
            ('外资在马来西亚制造业可以100%持股吗？','原则上可以。马来西亚自2003年已取消制造业外资持股限制，仅少数子行业（中小型包装材料70%、塑料废物回收等）有限制。但低附加值劳动密集型项目在NIA新框架下越来越难获得MIDA批准。'),
            ('马来西亚服务业的外资持股限制有哪些？','金融（银行30%、保险70%）、电信（网络设施49%、应用服务70%）、物流（货运代理49%、港口49%）、零售（须取WRT准证+100万令吉实缴资本）、教育（K-12≤49%、大学100%）等行业存在差异化外资上限。'),
        ],
        'related': ['19-malaysia-competition','41-malaysia-tax','04-malaysia-pdpa'],
    },
    '43_马来西亚外资房地产法律实务.md': {
        'slug': '43-malaysia-property', 'region': '马来西亚', 'tag': '房地产法',
        'date': '2026-07-21', 'desc': '中国买家连续五年居马国外资购房榜首。详解各州最低价格门槛（100万-200万令吉）、州政府同意函制度、马来保留地的绝对排他性、MM2H计划购房通道，以及Bumiputera配额对外资开发商的约束。',
        'faq': [
            ('外国人在马来西亚买房的最低价格门槛是多少？','吉隆坡100万令吉、雪兰莪100万-200万令吉（分三区）、柔佛100万-200万令吉、槟城100万（大陆）/200万（槟岛）。须取得州政府"外国人购房同意函"（审批2-6个月），马来保留地和Bumiputera Lot绝对禁止外国人购买。'),
            ('马来西亚第二家园(MM2H)对购房有什么优势？','2024年新MM2H分三类（银/黄金/白金），定存要求50万-500万令吉。MM2H持有者可购买低于州政府外国人最低价格门槛的住宅（柔佛/槟城适用较低标准），且州政府同意函审批相对宽松。'),
        ],
        'related': ['37-thailand-condominium','22-cambodia-land','42-malaysia-foreign-investment'],
    },
    '44_罗马尼亚税务制度与欧盟资金申请.md': {
        'slug': '44-romania-tax', 'region': '罗马尼亚', 'tag': '税务合规',
        'date': '2026-07-22', 'desc': '2025年ANAF转让定价稽查追缴3.5亿欧元增长43%。拆解16%企业所得税、19% VAT、中罗DTA 3%优惠预提税、RO e-Factura电子发票系统，以及中资企业申请欧盟结构性基金和PNRR的合规路径。',
        'faq': [
            ('罗马尼亚企业所得税税率是多少？','标准税率16%，是欧盟最低之一。微型企业（年营收≤50万欧元）适用1%-3%按营收征税制。中罗DTA提供3%的股息/利息/特许权使用费预提税率，是中国签署的最优DTA之一。2025年起全面实施RO e-Factura电子发票制度。'),
            ('在罗马尼亚的中资企业能申请欧盟资金吗？','可以。以罗马尼亚子公司（SRL/SA）身份申请。欧盟2021-2027年预算期对罗拨付约310亿欧元凝聚基金+292亿欧元PNRR复苏韧性基金。中资须证明子公司在罗具有"实质性经营"，部分项目需与欧盟本地企业组成联合体。'),
        ],
        'related': ['34-romania-company-law','14-romania-gdpr','05-romania-labor-law'],
    },
    '45_罗马尼亚可再生能源投资法律实务.md': {
        'slug': '45-romania-renewable-energy', 'region': '罗马尼亚', 'tag': '能源法',
        'date': '2026-07-23', 'desc': '2025年罗新增光伏2.1GW，中资占11%。拆解绿色证书→CfD制度转型、48个月开发全流程、弃电与并网延迟风险、中罗投资架构设计，以及CEISD外商投资审查对可再生能源项目的特殊影响。',
        'faq': [
            ('罗马尼亚可再生能源项目的开发周期有多长？','光伏项目从土地获取到商业运营约24-42个月，风电约30-54个月。最耗时节点：ATR并网审批（6-18个月）+建筑许可（6-12个月）+施工（光伏8-14月/风电12-24月）。2025年ANRE取消2MW以上项目自动并网许可，进一步延长了审批周期。'),
            ('罗马尼亚绿色证书制度发生了什么变化？','原绿色证书(CV)制度从2017年起多次削减（光伏从6 CV/MWh降至约3 CV）。2026年起对5MW以上新建项目引入CfD（差价合约）拍卖机制——15年期固定电价保证，取代CV制度。CfD提供更高的政策确定性，但拍卖竞争激烈程度不确定。'),
        ],
        'related': ['34-romania-company-law','44-romania-tax','39-fidic-contracts'],
    },
    '46_罗马尼亚争议解决与仲裁.md': {
        'slug': '46-romania-dispute', 'region': '罗马尼亚', 'tag': '争议解决',
        'date': '2026-07-24', 'desc': 'CICA-CCIR 2025年受理314件仲裁案涉中资企业21件增长36%。拆解法院四级审级、紧急仲裁员48小时裁定、欧盟EAPO账户冻结令、跨境判决裁决执行路径与中资企业维权策略。',
        'faq': [
            ('在罗马尼亚打官司，外国原告需要特别注意什么？','三个关键点：诉讼费用担保义务（非欧盟原告须提供不超争议金额10%的担保）、送达地址（须在罗指定送达代收人）、翻译义务（所有非罗语文件须附经认证的罗语翻译）。'),
            ('罗马尼亚仲裁裁决在中国法院执行的成功率如何？','两国均为纽约公约缔约国。CICA-CCIR裁决在中国的执行先例较少，建议选择SIAC或ICC仲裁——两家机构裁决在中国执行记录更丰富、可预期性更高。'),
            ('在罗马尼亚可以申请"诉前财产保全"吗？','可以。须同时满足：紧急情况+初步证据+保全担保（10%-20%保全金额）。法院3-10个工作日内裁定。银行账户冻结最快最有效——裁定送达银行后即时生效。'),
        ],
        'related': ['34-romania-company-law','44-romania-tax','10-asean-arbitration'],
    },
    '47_罗马尼亚外资安全审查深度解析.md': {
        'slug': '47-romania-fdi', 'region': '罗马尼亚', 'tag': '外资审查',
        'date': '2026-07-25', 'desc': '2026年第32号法律将CEISD审查股权触发门槛从25%降至10%，扩展至数据中心和AI领域。拆解三层触发机制、两阶段审查流程、抢跑最高投资额10%罚款与欧盟FDI筛选网络的叠加效应。',
        'faq': [
            ('什么样的投资100%会触发CEISD审查？','同时满足：非欧盟投资者+收购罗企业10%以上股权或获实际控制权+目标企业属关键行业（关键基础设施/关键技术/敏感数据/国防/媒体/健康）。可再生能源(≥50MW)、数据中心、半导体、5G通信最常触发审查。'),
            ('通过新加坡/香港子公司收购能规避CEISD审查吗？','不能。CEISD自2023年GEO 257/2023起实行穿透式审查——审查追溯至最终实际受益人(UBO)。即使收购主体是新加坡/香港子公司，如UBO仍为中国公民/实体，仍按非欧盟投资者标准审查。'),
        ],
        'related': ['34-romania-company-law','45-romania-renewable-energy','44-romania-tax'],
    },
    '48_罗马尼亚房地产与建筑工程.md': {
        'slug': '48-romania-realestate', 'region': '罗马尼亚', 'tag': '房地产法',
        'date': '2026-07-26', 'desc': '布加勒斯特核心区公寓突破2,500欧元/㎡。拆解外国人土地持有限制、共管公寓购买程序、CU至AC的12-24个月开发许可全流程、FIDIC合同的罗马尼亚法院本地化解释规则与中资开发商五查尽调清单。',
        'faq': [
            ('中国人个人能在罗马尼亚买房吗？','可自由购买共管公寓（永久产权），但不可直接购买土地。土地须通过在罗设立的实际经营子公司持有。购房资金须从中国境内银行以"境外购房"名义合法汇出。'),
            ('从签署预购合同到拿到钥匙需要多长时间？','新房（期房）：12-24个月。二手房：30-60天——核心环节是CF产权核查（5-15天）+公证人准备合同（5-10天）+CF登记（10-20天）。'),
        ],
        'related': ['34-romania-company-law','05-romania-labor-law','39-fidic-contracts'],
    },
    '49_马来西亚争议解决与仲裁.md': {
        'slug': '49-malaysia-dispute', 'region': '马来西亚', 'tag': '争议解决',
        'date': '2026-07-27', 'desc': 'AIAC 2025年受理187件仲裁案涉中资29件。拆解HCM商事庭快速审判、即决判决机制、CIPAA 45天建筑业快速裁决、Mareva禁制令数小时内冻结资产与SIAC/AIAC仲裁条款设计策略。',
        'faq': [
            ('马来西亚法院诉讼和仲裁，哪个更适合中资企业？','仲裁。仲裁裁决在《纽约公约》框架下跨境执行通畅，法院判决的跨境执行存在显著障碍。仲裁保密性强、一裁终局。法院诉讼的优势场景是：需Mareva禁制令或即决判决快速追偿。'),
            ('马来西亚仲裁裁决在中国执行的成功率如何？','AIAC/SIAC裁决在中国法院获得承认执行的总体成功率约80%-85%。主要失败原因：仲裁协议无效、仲裁通知未适当送达。选择SIAC仲裁时受益于中新双边司法协作的良好基础。'),
        ],
        'related': ['10-asean-arbitration','19-malaysia-competition','42-malaysia-foreign-investment'],
    },
    '50_马来西亚知识产权保护.md': {
        'slug': '50-malaysia-ip', 'region': '马来西亚', 'tag': '知识产权',
        'date': '2026-07-28', 'desc': '中资企业马来西亚商标申请量居外国首位（5,872件），但抢注案件同比增长47%。拆解先申请原则下的攻防体系、ASPEC/PPH专利加速审查、海关边境措施与品牌出海反抢注的六步实战策略。',
        'faq': [
            ('中国注册商标在马来西亚受保护吗？','不自动保护。须通过马德里体系指定马来西亚或直接在MyIPO提交国家申请。驰名商标虽有巴黎公约反抢注保护但门槛极高，建议直接注册而非依赖驰名商标保护。'),
            ('马来西亚实用新型和发明专利如何选择？','渐进式改进（设备优化、流程改进）→申请实用新型（审查12-18个月）。突破性创新（全新化合物/药物/核心算法）→申请发明专利（审查3-5年）。中资制造企业通常双轨并行——核心产品申请发明专利，外围改进申请实用新型。'),
        ],
        'related': ['23-cambodia-ip','04-malaysia-pdpa','42-malaysia-foreign-investment'],
    },
    '51_马来西亚建筑工程法律实务.md': {
        'slug': '51-malaysia-construction', 'region': '马来西亚', 'tag': '工程法',
        'date': '2026-07-29', 'desc': 'CIDB注册G7外资承包商420家中资占38%。拆解CIDB七级注册体系、PWD/PAM/FIDIC合同选择策略、CIPAA 45天建筑业快速裁决机制、CCC完工合规证书制度与中资承包商劳动力/环保红线。',
        'faq': [
            ('CIPAA裁决和普通仲裁有什么区别？','CIPAA是马来西亚特有的建筑业法定裁决机制——速度极快（45个工作日内裁决）、成本低（3,000-15,000令吉）、裁决具临时约束力（业主须先行支付再通过仲裁"重新决定"）。普通仲裁需12-18个月。对中资承包商而言CIPAA是追讨工程款的首选工具。'),
            ('马来西亚CIDB的G7注册有什么要求？','最低实缴资本750,000令吉+至少2名本地持牌技术负责人+最近3年累计完成建筑工程不低于5,000万令吉+ISO 9001认证+无破产/清算记录。申请周期通常3-6个月。'),
        ],
        'related': ['06-cambodia-construction','39-fidic-contracts','10-asean-arbitration'],
    },
    '52_越南争议解决与仲裁.md': {
        'slug': '52-vietnam-dispute', 'region': '越南', 'tag': '争议解决',
        'date': '2026-07-30', 'desc': 'VIAC 2025年受理412件仲裁案涉中资78件占19%，中资是VIAC最大外国用户。拆解法院四级审级与五大诉讼阶段、VIAC 2024版紧急仲裁员规则、SIAC裁决在越承认的公共秩序风险与中资企业合同争议解决条款设计。',
        'faq': [
            ('在越南打官司和在越南仲裁，应该怎么选？','仲裁优先。VIAC裁决可通过纽约公约在170+国家执行——越南法院判决的跨境执行通道几乎不存在。法院诉讼的优势是：争议金额低、需要紧急临时措施或涉及破产。'),
            ('SIAC和VIAC应该怎么选？','争议金额超50万美元或对方为越南国企→SIAC（新加坡），裁决国际公信力强、新加坡法院支持仲裁。争议金额较低或对方为越南私企→VIAC，费用远低于SIAC。'),
        ],
        'related': ['15-vietnam-investment-law','35-vietnam-tax','10-asean-arbitration'],
    },
    '53_越南房地产法律实务.md': {
        'slug': '53-vietnam-realestate', 'region': '越南', 'tag': '房地产法',
        'date': '2026-07-31', 'desc': '胡志明市核心区公寓突破5,000美元/㎡，中资占工业用地外资交易38%。拆解2024年《土地法》市场化地价改革、外国人30%公寓配额与50年产权限制、工业用地租赁权抵押新规与代持绝对无效的司法红线。',
        'faq': [
            ('中国人能在越南买地建厂吗？','不能直接买地。外资制造企业须向工业区开发商租赁工业用地（租期最长50年）。2024年《土地法》首次允许外资将租赁权抵押给银行。建议优先选择国家级/省级工业园区内的地块。'),
            ('中国人在越南买房有风险吗？','主要风险：产权期限仅50年（越南公民为长期稳定）、外国人配额限制（单个项目不超30%）、代持被绝对禁止且不受法律保护。购买前须请越南持牌律师完成产权核查和开发商资质核查。'),
        ],
        'related': ['15-vietnam-investment-law','29-vietnam-labor','22-cambodia-land'],
    },
    '54_越南知识产权保护.md': {
        'slug': '54-vietnam-ip', 'region': '越南', 'tag': '知识产权',
        'date': '2026-08-01', 'desc': '中资商标申请量居越南外国首位（7,352件），抢注异议案件同比增长52%。拆解2022年《知识产权法》"恶意抢注"新武器、商标异议2个月黄金窗口、专利侵权证据保全令与海关行政查处的三重执法体系。',
        'faq': [
            ('越南商标被抢注了怎么应对？','分两种情况：商标在公告期（公告后2个月内）→火速提交异议（2022年修订新增"恶意"为独立异议理由）。商标已完成注册→提交无效宣告（理由：恶意抢注或连续5年未使用）。2个月异议期是黄金窗口，错过将转入成本更高的无效宣告程序。'),
            ('中资企业在越南如何进行海关备案保护？','商标/专利/版权在NOIP完成注册后向海关总局提交"知识产权海关保护申请"。海关备案有效期1年（可续展）。海关发现涉嫌侵权货物将在10个工作日内通知权利人——须在10个工作日内要求暂停通关（暂停期限20+20个工作日）。'),
        ],
        'related': ['23-cambodia-ip','07-vietnam-data-localization','15-vietnam-investment-law'],
    },
}
